...
/path/to/vanilla/extensions/FCKAjaxQuote/default.php
...
Adds quote option to posts. Works with FCKEditor (retrives original data from DB on the fly).
Redirects to last(CommentBox) page if needed.

This extension is compatible with Add Comments;
